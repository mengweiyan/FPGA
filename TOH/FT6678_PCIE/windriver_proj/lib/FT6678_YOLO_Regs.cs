...
namespace Jungo.ft6678_yolo_lib
{
    ...
    public class FT6678_YOLO_Regs
    {
        private const uint WDC_AD_CFG_SPACE = 0xFF;
        public readonly WDC_REG[] gFT6678_YOLO_CfgRegs = new WDC_REG[]
        {
        ...
        public readonly WDC_REG[] gFT6678_YOLO_RT_Regs = 
        {
            new WDC_REG((DWORD)PCI_BARS.AD_PCI_BAR0, 0x0, wdc_lib_consts.WDC_SIZE_32, WDC_DIRECTION.WDC_READ_WRITE, "Image", "")
        };
    };
